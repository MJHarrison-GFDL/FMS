...
public :: data_override_UG, data_override_initialized
...
! Test if grid_file is already opened
 ...
 if(field_exist(grid_file, "x_T" ) .OR. field_exist(grid_file, "geolon_t" ) ) then
  ...
  function data_override_initialized()
    logical :: data_override_initialized

    if (module_is_initialized) then
       data_override_initialized = .true.
    else
       data_override_initialized = .false.
    endif
  end function data_override_initialized
